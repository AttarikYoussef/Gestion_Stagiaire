...
/**
 * Servlet implementation class ServletValidationJure
 */
@WebServlet("/ServletValidationJure")
public class ServletValidationJure extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletValidationJure() {
        super();
