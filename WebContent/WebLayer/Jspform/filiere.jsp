...
<body>
 ...
 <%  
         ...
         if (session.getAttribute("bean")==null) {
        	 beandem  = new Beanfiliere();
         %>
         <%
         }
         else {
        	 beandem = (Beanfiliere)session.getAttribute("bean");
         }
	...
	<div class="container">
		<div class="jumbotron">
			<div class="card">
			  ...
			  <div class="card-body">
			    <h5 class="card-title"><i class="fas fa-chevron-down"></i> Filiéres: </h5> 
			    	<div class="row" style="float: right;">
				    	<div class="col-md-12 ">
				    	<cennter>
				    		<button class="btn btn-success rounded-pill" data-bs-toggle="modal" data-bs-target="#add"><i class="fas fa-plus-circle"></i> Ajout filiére</button><br>
				    		</cennter>
				    	</div>
				    </div>
			    	<br>
				    ...
				    <table class="table table-dark table-hover table-bordered">
					  <thead>
					    <tr>
					      <th scope="col" style="width:12%"><i class="fas fa-list-ol"></i> Id_filiere</th>
